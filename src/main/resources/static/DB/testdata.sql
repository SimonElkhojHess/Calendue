...
INSERT INTO `calendue`.`task` (`subproject_id`, `task_name`, `task_description`, `task_comment`, `task_deadline`, `task_hours`, `task_priority`, `task_status`) VALUES
                                                                                                                                                                    ...
                                                                                                                                                                    (40, 'UI Development', 'Develop frontend components based on wireframes', '', '22/05/2023', 8, 8, 'Done'),
                                                                                                                                                                    (40, 'UI Testing', 'Perform testing of the implemented UI for usability', '', '25/05/2023', 4, 2, 'Done');

INSERT INTO `calendue`.`task` (`subproject_id`, `task_name`, `task_description`, `task_comment`, `task_deadline`, `task_hours`, `task_priority`, `task_status`) VALUES
                                                                                                                                                                    (41, 'Backend API Development', 'Develop backend APIs for data manipulation', '', '22/05/2023', 8, 8, 'In Progress'),
                                                                                                                                                                    (41, 'Integration Testing', 'Perform integration testing for the implemented APIs', '', '25/05/2023', 4, 6, 'In Progress'),
                                                                                                                                                                    (41, 'Documentation', 'Prepare documentation for the implemented functionalities', '', '28/05/2023', 4, 4, 'To Do');

INSERT INTO `calendue`.`task` (`subproject_id`, `task_name`, `task_description`, `task_comment`, `task_deadline`, `task_hours`, `task_priority`, `task_status`) VALUES
                                                                                                                                                                    (42, 'Database Design and Setup', 'Design and set up the project database', '', '25/05/2023', 6, 6, 'To Do'),
                                                                                                                                                                    (42, 'Backend Development', 'Implement backend functionality based on requirements', '', '28/05/2023', 8, 8, 'To Do'),
                                                                                                                                                                    (42, 'Testing and Bug Fixing', 'Perform testing and fix any identified bugs', '', '30/05/2023', 8, 5, 'To Do');

INSERT INTO `calendue`.`task` (`subproject_id`, `task_name`, `task_description`, `task_comment`, `task_deadline`, `task_hours`, `task_priority`, `task_status`) VALUES
                                                                                                                                                                    (43, 'Research and Analysis', 'Conduct research and analysis on the target market', '', '15/05/2023', 6, 7, 'In Progress'),
                                                                                                                                                                    (43, 'Product Design', 'Design the product features and user interface', '', '18/05/2023', 8, 8, 'In Progress'),
                                                                                                                                                                    (43, 'Prototype Development', 'Develop a functional prototype of the product', '', '22/05/2023', 10, 7, 'To Do');
